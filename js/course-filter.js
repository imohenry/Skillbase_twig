...
filterSelection("digital-payments")
...
for (var i = 0; i < btns.length; i++) {
  btns[i].addEventListener("click", function() {
    var current = document.getElementsByClassName("active-course");
    current[0].className = current[0].className.replace(" active-course", "");
    this.className += " active-course";
  });
}
...
// The responsive for the course on the home page
